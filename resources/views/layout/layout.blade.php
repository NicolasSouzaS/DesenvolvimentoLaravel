                ...
                <ul>
                    ...
                    <li class="menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="gallery-2.html">Página De Galeria 02</a></li>
                            <li><a href="project.html">Página De Projeto</a></li>
                            <li><a href="project-details.html">Detalhes De Projeto</a></li>
                    ...
                    <li class="menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="blog-details.html">Detalhes De Blog</a></li>
                        </ul>
                    </li>
                    <li>
